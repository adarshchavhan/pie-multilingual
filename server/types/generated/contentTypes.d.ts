...
export interface ApiBannerBanner extends Schema.CollectionType {
  ...
  attributes: {
    bannerImg: Attribute.Media & Attribute.Required;
    clientImg: Attribute.Media & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiCountrySectionCountrySection extends Schema.SingleType {
  collectionName: 'country_sections';
  info: {
    singularName: 'country-section';
    pluralName: 'country-sections';
    displayName: 'Country-section';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::country-section.country-section',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiServiceSectionServiceSection extends Schema.SingleType {
  ...
  attributes: {
    heading: Attribute.String & Attribute.Required;
    serviceCards: Attribute.Relation<
...
export interface ApiVideoSectionVideoSection extends Schema.SingleType {
...
declare module '@strapi/strapi' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::country-section.country-section': ApiCountrySectionCountrySection;
